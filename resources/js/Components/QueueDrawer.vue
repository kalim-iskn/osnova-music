            ...
            <div class="queue-drawer__panel">
                <div class="queue-drawer__header">
                    <div>
                        ...
                        <p>{{ player.queue.length }} трек(ов)</p>
                    </div>
                    <div class="queue-drawer__header-actions">
                        <button class="ghost-button ghost-button--small" type="button" @click="player.clearQueue()">Очистить</button>
                        <button class="ghost-button ghost-button--small" type="button" @click="player.toggleQueue()">Закрыть</button>
                    </div>
                </div>

                <div class="queue-drawer__list">
                    <button
